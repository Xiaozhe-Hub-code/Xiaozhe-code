        ...
        <div class="box_1 flex-row">
            ...
            <div class="group_1 ">
                ...
                <el-countdown v-if="examEndTime && new Date() < new Date(examEndTime)" class="exam-time-countdown"
                    @finish="handleCountdownFinish" format="DD [days] HH:mm:ss" title="距离竞赛结束还有:"
...
import { getExamFirstQuestionService , examPreQuestionService ,examNextQuestionService} from "@/apis/exam"
...
function handleCountdownFinish() {
    ...
    ElMessageBox.alert('当前比赛已经结束,将自动退出！', '比赛结束通知', {
        confirmButtonText: 'OK',
    })
    console.log('开始等待 3 秒...');
    setTimeout(() => {
        console.log('3 秒已过，退出比赛！');
