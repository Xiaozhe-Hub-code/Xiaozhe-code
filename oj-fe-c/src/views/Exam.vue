                            ...
                            <div class="exam-button-container">
                                ...
                                <div v-if="isHistoryExam(exam)">
                                    ...
                                    <el-button class="exam-rank-button" type="primary" plain
                                        @click="togglePopover(exam.examId,exam.endTime)">查看排名</el-button>
                                </div>
...
function togglePopover(examId,examEndTime) {
    // 获取比赛结束时间
    ...
    // 如果当前时间小于第二天凌晨2点，不允许查看排名
    if (new Date() < nextDay){
        ElMessage.error('排名正在统计中,请于次日凌晨2点后查看')
        return
    }
