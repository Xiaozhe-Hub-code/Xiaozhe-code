<template>
    <div class="login-page">
        ...
        <div class="login-box">
            <div class="logo-box">
                <div class="right">
                    <div class="sys-name">在线OJ后台管理平台</div>
            ...
            <div class="form-box">
                ...
                <div class="form-item">
                    ...
                    <el-input show-password type="password" v-model="password" placeholder="请输⼊密码" />
                </div>
...
async function loginFun() {
    try {
        const loginResult = await loginService(userAccount.value, password.value); // 通过loginService传参给后端  并用await拿到后端返回的响应
