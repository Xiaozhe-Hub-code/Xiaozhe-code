    ...
    <div class="add-exam-component-box">
        <div class="add-exam-component">
                ...
                <div class="exam-base-info">
                    <div class="group-box">
                        <div class="group-item">
                            ...
                            <div>
                                <el-input maxlength="30" show-word-limit v-model="formExam.title" style="width:420px" placeholder="请填写竞赛名称"></el-input>
                            </div>
                        </div>
                    </div>
                    <div class="group-box">
            ...
            <div class="exam-select-question-box">
                ...
                <el-table height="300px" :data="formExam.questionSet" class="question-select-list">
            ...
            <div>
                <el-dialog v-model="dialogVisible">
                    <div class="exam-list-box">
                        <div class="exam-list-title required">选择竞赛题目(您选择的顺序，即竞赛题目的顺序)</div>
                        <el-form inline="true">
                        ...
                        <div class="exam-question-list-button">
                            <el-pagination background size="small" layout="total, sizes, prev, pager, next, jumper"
                                :total="total" v-model:current-page="params.pageNumber" v-model:page-size="params.pageSize"
                                :page-sizes="[1, 3, 5, 10, 15, 20]" @size-change="handleSizeChange"
...
function checkParams() {
    if (formExam.title === null || formExam.title === '') {
        ElMessage.error('请填写竞赛名称');
        return false;
    }
    if (formExam.examDate === null || formExam.examDate === '') {
        ElMessage.error('请填写竞赛周期');
        return false;
    }
    return true;
}
...
async function saveBaseInfo() {
    ...
    if (formExam.examId) {
        ...
        const addResExamId = await examAddService(fd)
        formExam.examId = addResExamId.data
    }
...
async function getQuestionList() {
    var ids = '';
    for (let i = 0; i < formExam.questionSet.length; i++) {
        var id = formExam.questionSet[i].questionId
        ids += id;
        if (i !== formExam.questionSet.length - 1) {
            ids += ';';
        }
    }
    params.questionIdsStr = ids;
...
async function submitSelectQuestion() {
    ...
    console.log(examQ)
    console.log(questionIdSet.value);
